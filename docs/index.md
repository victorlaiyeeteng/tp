...
**FriendBook is a desktop application for managing your friends, and your plans with them.** While it has a GUI, most of the user interactions happen using a CLI (Command Line Interface).
