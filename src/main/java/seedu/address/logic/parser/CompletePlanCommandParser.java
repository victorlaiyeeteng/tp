...
/**
 * Parses input arguments and creates a new CompletePlanCommand object
 */
public class CompletePlanCommandParser implements Parser<CompletePlanCommand> {
    ...
    public CompletePlanCommand parse(String args) throws ParseException {
        try {
            ...
            return new CompletePlanCommand(index);
        } catch (ParseException pe) {
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT, CompletePlanCommand.MESSAGE_USAGE), pe);
        }
    }
